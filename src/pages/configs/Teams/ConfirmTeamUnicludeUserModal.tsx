...
export function ConfirmTeamUnicludeUserModal( { isOpen, toRemoveUser, toRemoveTeamId, afterRemove, onRequestClose } : ConfirmTeamRemoveModalProps){
        ...
        try{
            const branchesData: Sync = toRemoveUser.branches.reduce(
                (syncTeams: Sync, userBranch: Branch) => {
                  if(userBranch.id !== toRemoveTeamId){
            ...
            await api.post(`/users/${toRemoveUser.id}/sync_teams`, branchesData);

            toast({
                title: "Sucesso",
                description: "Usuário foi desvinculado da equipe",
                status: "success",
                duration: 12000,
                isClosable: true,
            });
    ...
    return(
        <Modal isOpen={isOpen} onClose={onRequestClose} size="xl">
            ...
            <ModalContent borderRadius="24px">
                <ModalHeader p="10" fontWeight="700" fontSize="2xl">Desvincular {toRemoveUser.name} dessa equipe?</ModalHeader>
