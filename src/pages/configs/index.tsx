...

                    {
...

                      {
                        HasPermission(permissions, "Comissões Completo") && (
                            <Link href={`/${prefix}/commissions`} w="200px" borderRadius="4px" borderLeft="3px solid" borderColor="blue.800" fontSize="md" bg="white" _hover={{textDecor: 'none', boxShadow: 'md'}} px="6" py="3" boxShadow="sm" color="blue.800" display="flex" direction="row">
                                <BagIcon stroke="#4e4b66" fill="none" width="20"/>
                                <Text fontWeight="regular" ml="3" color="gray.800" lineHeight="25px">Comissões</Text>
                            </Link>
                        )
                    }
