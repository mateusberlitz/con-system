...
export function ConfirmPartialBillRemoveModal( { isOpen, toRemoveBillData, afterRemove, onRequestClose } : ConfirmPaymentRemoveModalProps){
    ...
    const handleRemovePayment = async () => {
        try{
            await api.delete(`/partial_bills/destroy/${toRemoveBillData.id}`);

            toast({
                title: "Sucesso",
                description: `Recebido parcial removido`,
                status: "success",
                duration: 12000,
                isClosable: true,
            });
    ...
    return(
        <Modal isOpen={isOpen} onClose={onRequestClose} size="xl">
            ...
            <ModalContent borderRadius="24px">
                <ModalHeader p="10" fontWeight="700" fontSize="2xl">Remover recebido parcial</ModalHeader>
