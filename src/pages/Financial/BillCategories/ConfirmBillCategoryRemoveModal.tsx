...
export function ConfirmBillCategoryRemoveModal({
  isOpen,
  toRemoveBillCategoryId,
  afterRemove,
  onRequestClose
}: ConfirmBillCategoryRemoveModalProps) {
    ...
    <Modal isOpen={isOpen} onClose={onRequestClose} size="xl">
      ...
      <ModalContent borderRadius="24px">
        <ModalHeader p="10" fontWeight="700" fontSize="2xl">
          Remover a categoria selecionada?
        </ModalHeader>
        ...
        <ModalBody pl="10" pr="10">
          <SolidButton
            onClick={handleBillPaymentCategory}
            mr="6"
            color="white"
            bg="red.400"
