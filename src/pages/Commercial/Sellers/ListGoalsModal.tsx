...
export function ListGoalsModal({
  isOpen,
  onRequestClose,
  afterEdit,
  goals,
    ...
    <Modal isOpen={isOpen} onClose={onRequestClose} size="xl">
      ...
      <ModalContent as="form" borderRadius="24px">
        <ModalHeader p="10" fontWeight="700" fontSize="2xl">
          Metas do vendedor(a) {toAddUserData.name}
        </ModalHeader>
              ...
              return (
                <>
                  <HStack>
                    <Stack spacing="0">
                      <Text>
                        {monthNames[goal.month]}/{goal.year}:{' '}
                      </Text>
                      ...
                      <HStack>
                        ...
                        <Text>
                          Visitas: <b>{goal.visits ? goal.visits : 'Vazio'}</b>
                        </Text>
                        <Text>
                          Fechamentos:{' '}
                          <b>{goal.sales ? goal.sales : 'Vazio'}</b>
                        </Text>
