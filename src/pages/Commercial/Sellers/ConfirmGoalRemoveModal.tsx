...
export function ConfirmGoalRemoveModal( { isOpen, toRemoveGoalData, afterRemove, onRequestClose } : ConfirmGoalRemoveModalProps){
    ...
    return(
        <Modal isOpen={isOpen} onClose={onRequestClose} size="xl">
            ...
            <ModalContent borderRadius="24px">
                <ModalHeader p="10" fontWeight="700" fontSize="2xl">Remover a meta do vendedor(a) {toRemoveGoalData.name}?</ModalHeader>
