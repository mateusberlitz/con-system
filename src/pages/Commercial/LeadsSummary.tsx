...
import { Bill, DataOrigin, Lead, LeadStatus, Payment } from "../../types";
...
export function LeadsSummary(){
    ...
    return (
        <>
            <NewLeadModal statuses={statuses} origins={origins} afterCreate={leads.refetch} isOpen={isNewLeadModalOpen} onRequestClose={CloseNewLeadModal}/>
