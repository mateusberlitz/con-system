...
export function Profile(){
    ...
    return(
        <Flex ml="auto" title="Ver informações ou sair" cursor="pointer">
            { profile && (
                <Link to="/eu">
                    <Stack spacing="1" width="max-content" mr="4" mt="1" textAlign="right" _hover={{textDecoration: "none"}}>
            ...
            <Flex mt="3" ml="6" title="Sair e fazer logout do sistema" onClick={OpenLogoutModal}>
