...
export function ControlledCheckbox({control, label, defaultIsChecked, name, value, error, ...rest} : ControlledCheckboxProps){
    ...
    return(
        <Controller 
            ...
            render={({ field: {ref, onChange, ...field} }) => 
                    <Checkbox ref={ref} {...field} name={name} error={error} onChange={(event) => {handleChangeIsIndividualChecked(); onChange(event);}} isChecked={isIndividualChecked} colorScheme="blue" size="md" mr="15" borderRadius="full" fontSize="sm" color="gray.800" value={value}>
                        {label}
                    </Checkbox>
            }
        />
